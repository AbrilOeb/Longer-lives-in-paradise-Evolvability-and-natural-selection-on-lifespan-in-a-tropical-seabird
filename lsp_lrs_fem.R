...
# MODEL: HERITABILITY OF LIFESPAN and LRS for FEMALE RECRUITS
...
setwd("/srv/home/abriloeb/wp2/h2/females")
...
bfb_females <- readRDS("bfb_females.rds")
...
bfb_females <- select(bfb_females, animal, sire, dam, nest, cohort, lifespan, lrs.fledged)
...
lsp_lrs_fem <- MCMCglmm(cbind(lifespan, lrs.fledged) ~ trait - 1,
...
saveRDS(lsp_lrs_fem,
        file = paste("lsp_lrs_fem_", args, ".rds", sep=""))
