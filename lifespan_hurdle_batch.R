...
# MODEL: HERITABILITY OF LIFESPAN
...
setwd("/srv/home/abriloeb/wp1/h2/lifespan/all")
...
bfb_all <- select(bfb_all, animal, sire, dam, nest, cohort, lifespan)
...
prior_lsp_hurdle<- list(G=list(G1=list(V=diag(2),nu=2),
...
lsp_hurdle_batch <- MCMCglmm(lifespan ~ trait-1 ,
...
saveRDS(lsp_hurdle_batch,
        file = paste("lsp_hurdle_batch_", args, ".rds", sep=""))
