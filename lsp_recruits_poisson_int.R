...
# MODEL: HERITABILITY OF LIFESPAN for RECRUITS
...
setwd("/srv/home/abriloeb/wp1/h2/lifespan/recruits/sex_interaction")
...
bfb_recruits <- select(bfb_recruits, animal, sire, dam, sex, nest, cohort, lifespan)
...
lsp_recruits_int_batch <- MCMCglmm(lifespan ~ sex,
...
saveRDS(lsp_recruits_int_batch,
        file = paste("lsp_recruits_int_batch_", args, ".rds", sep=""))
